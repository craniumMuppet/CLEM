#!/usr/bin/env python3
"""Generate synchronized v2.28.0 fractional-Arctic validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    ...
    write_json("VALIDATION_SUMMARY_V2_28_0.json", summary)
    ...
    write_json("DEEP_VALIDATION_V2_28_0.json", deep)
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_28_0.json", audit)
    print(
        json.dumps(
            {
