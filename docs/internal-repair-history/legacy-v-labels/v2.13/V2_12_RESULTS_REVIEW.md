# v2.12 out-of-sample validation review

## Verdict

The v2.11 physics passes the v2.12 held-out validation suite at both 10 degree and 5 degree resolution. No physics coefficient was changed for v2.12.
...
The v2.11 dynamics are acceptable as the current physics candidate for the tested scope. v2.13 is a release-consistency repair only: it fixes stale public CLI defaults and documentation while preserving the validated core-model AST exactly.
