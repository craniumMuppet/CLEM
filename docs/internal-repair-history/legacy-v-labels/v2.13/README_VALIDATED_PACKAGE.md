# v2.12 out-of-sample validation

The physics source is unchanged from the all-pass v2.11 candidate. For the next local run, use **`RUN_V2_12_OUT_OF_SAMPLE_VALIDATION.cmd`**. It runs only the new SSP2-4.5, cross-resolution, and untuned hosing-dose tests and produces the usual `physics_verification_bundle.zip`. See `PHYSICS_REPAIR_V2_12.md` and `V2_11_RESULTS_REVIEW.md`.
