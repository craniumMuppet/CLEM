...
def evaluate_result(result: Any) -> dict[str, Any]:
    ...
    prospective_untouched_validation_complete = False
    ...
    return {
        ...
        "area_operator": {
            ...
            "continuous_below_threshold": False,
            "monotone": True,
            ...
            "extent_interpretation": (
                "Extent is a deterministic threshold diagnostic of the native two-sector prognostic concentration. "
                "It contains no fitted historical area-to-extent multiplier."
            ),
        },
