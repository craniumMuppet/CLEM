#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.10 scientific-review-fix archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_10_integrity_recovery"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v22910_tasks/",
    "validation_v22910_tasks_final/",
)
...
REQUIRED = (
    ...
    "run_state.py",
    "co2_target_sweep.py",
    "V2_29_10_INTEGRITY_RECOVERY.md",
    "VALIDATION_SUMMARY_V2_29_10.json",
    "DEEP_VALIDATION_V2_29_10.json",
    "IMPLEMENTATION_AUDIT_V2_29_10.json",
    "PACKAGE_FILE_MANIFEST_V2_29_10.json",
    "TEST_RESULTS_V2_29_10.txt",
    ...
    "tools/package_v22910.py",
    "tools/run_v22910_validation_parallel.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_10.json"
    entries = []
