#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.12 scientific-review-fix archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_12_monte_carlo_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v22912_tasks/",
    "validation_v22912_tasks_final/",
)
...
REQUIRED = (
    ...
    "run_state.py",
    "co2_target_sweep.py",
    "V2_29_12_MONTE_CARLO_INTEGRITY.md",
    "VALIDATION_SUMMARY_V2_29_12.json",
    "DEEP_VALIDATION_V2_29_12.json",
    "IMPLEMENTATION_AUDIT_V2_29_12.json",
    "PACKAGE_FILE_MANIFEST_V2_29_12.json",
    "TEST_RESULTS_V2_29_12.txt",
    ...
    "tools/package_v22912.py",
    "tools/run_v22912_validation_parallel.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_12.json"
    entries = []
