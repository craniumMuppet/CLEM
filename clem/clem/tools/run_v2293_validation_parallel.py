#!/usr/bin/env python3
"""Run all v2.29.3 validation tasks in isolated parallel subprocesses."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "validation_v2293_tasks_final",
    )
    ...
    from validate_v2293 import _assemble_records
