#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.28.0 fractional-Arctic archive."""
...
PREFIX = "emergent_global_climate_model_v2_28_0_fractional_arctic"
EXCLUDED_PREFIXES = (
...
REQUIRED = (
    "climate_model.py",
    "README.md",
    "V2_28_0_FRACTIONAL_ARCTIC.md",
    "VALIDATION_SUMMARY_V2_28_0.json",
    "DEEP_VALIDATION_V2_28_0.json",
    "IMPLEMENTATION_AUDIT_V2_28_0.json",
    "TEST_RESULTS_V2_28_0.txt",
    "run_tests.py",
    "isolated_pytest_exit.py",
    "tests/test_v228_fractional_arctic.py",
)
