#!/usr/bin/env python3
"""Run all v2.29.4 validation tasks in isolated parallel subprocesses."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "validation_v2294_tasks_final",
    )
    ...
    from validate_v2294 import _assemble_records
