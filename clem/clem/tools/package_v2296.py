#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.6 accuracy and evidence-integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_6_native_arctic_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v2296_tasks/",
    "validation_v2296_tasks_final/",
)
EXCLUDED_SUFFIXES = (".pyc", ".pyo", ".tmp", ".bak", ".tolbak", ".stage0")
EXCLUDED_FILE_NAMES = set()
EXCLUDED_FILE_PREFIXES = (
    "validation_v2296_test_nodes",
    "validation_v2296_test_results",
    "validation_v2296_isolated_runner",
    "validation_v2296_parallel_runner",
    "validation_v2296_suite_",
)
REQUIRED = (
    "climate_model.py",
    "monte_carlo.py",
...
def release_files() -> list[Path]:
    ...
    for path in ROOT.rglob("*"):
        ...
        if relative.name.startswith(EXCLUDED_FILE_PREFIXES):
            continue
        if relative_text.startswith("validation_v2296_test_logs"):
            continue
        files.append(path)
