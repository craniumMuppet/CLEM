#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.3 release-integrity maintenance archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_3_release_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v2293_tasks/",
    "validation_v2293_tasks_final/",
)
EXCLUDED_SUFFIXES = (".pyc", ".pyo", ".tmp", ".bak", ".tolbak")
EXCLUDED_FILE_NAMES = set()
EXCLUDED_FILE_PREFIXES = (
    "validation_v2293_test_nodes",
    "validation_v2293_test_results",
    "validation_v2293_isolated_runner",
    "validation_v2293_parallel_runner",
    "validation_v2293_suite_",
)
REQUIRED = (
    "climate_model.py",
    "monte_carlo.py",
    ...
    "README.md",
    "CHANGELOG.md",
    "V2_29_3_OPERATIONAL_SAFETY.md",
    "VALIDATION_SUMMARY_V2_29_3.json",
    "DEEP_VALIDATION_V2_29_3.json",
    "IMPLEMENTATION_AUDIT_V2_29_3.json",
    "TEST_RESULTS_V2_29_3.txt",
    "validate_v2293.py",
    "run_tests.py",
...
def release_files() -> list[Path]:
    ...
    for path in ROOT.rglob("*"):
        ...
        if relative.name.startswith(EXCLUDED_FILE_PREFIXES):
            continue
        if relative_text.startswith("validation_v2293_test_logs"):
            continue
        files.append(path)
