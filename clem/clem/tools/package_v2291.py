#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.1 maintenance archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_1_arctic_phase_consistency"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
REQUIRED = (
    ...
    "README.md",
    "CHANGELOG.md",
    "V2_29_1_ARCTIC_PHASE_CONSISTENCY.md",
    "VALIDATION_SUMMARY_V2_29_1.json",
    "DEEP_VALIDATION_V2_29_1.json",
    "IMPLEMENTATION_AUDIT_V2_29_1.json",
    "TEST_RESULTS_V2_29_1.txt",
    "validate_v2291.py",
    "run_tests.py",
