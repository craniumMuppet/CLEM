#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.15 winter sea-ice integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_15_winter_sea_ice_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v22915_tasks/",
    "validation_v22915_tasks_final/",
)
...
REQUIRED = (
    ...
    "VALIDATION_SUMMARY_V2_29_15.json",
    "DEEP_VALIDATION_V2_29_15.json",
    "IMPLEMENTATION_AUDIT_V2_29_15.json",
    "PACKAGE_FILE_MANIFEST_V2_29_15.json",
    "TEST_RESULTS_V2_29_15.txt",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_15.json"
    entries = []
