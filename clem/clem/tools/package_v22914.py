#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.14 recovery and winter-sea-ice archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_14_recovery_winter_sea_ice"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
REQUIRED = (
    ...
    "VALIDATION_SUMMARY_V2_29_14.json",
    "DEEP_VALIDATION_V2_29_14.json",
    "IMPLEMENTATION_AUDIT_V2_29_14.json",
    "PACKAGE_FILE_MANIFEST_V2_29_14.json",
    "TEST_RESULTS_V2_29_14.txt",
    ...
    "tools/package_v22914.py",
    "tools/run_v22914_validation_parallel.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_14.json"
    entries = []
