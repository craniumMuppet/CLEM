#!/usr/bin/env python3
"""Generate synchronized v2.29.14 accuracy and evidence-integrity validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    """Assemble v2.29.14 records with evidence and release gates separated."""
    ...
    release_checks = {
        "v22914_version": MODEL_VERSION == "2.29.14",
        ...
        "winter_lead_closure_is_volume_only_and_public": bool(
    ...
    write_json("VALIDATION_SUMMARY_V2_29_14.json", summary)
    write_json("DEEP_VALIDATION_V2_29_14.json", deep)
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_29_14.json", audit)
    ...
    if not summary["all_release_checks_passed"]:
        ...
        raise SystemExit("v2.29.14 release validation failed: " + ", ".join(failed))
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v22914_") as directory:
