#!/usr/bin/env python3
"""Generate synchronized v2.29.6 accuracy and evidence-integrity validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    ...
    release_checks = {
        "v2296_version": MODEL_VERSION == "2.29.6",
        ...
        "native_control_sea_ice_area": bool(
            12.7 <= native_reference["native_march_ice_area_million_km2"] <= 13.8
            and 3.7 <= native_reference["native_september_ice_area_million_km2"] <= 4.8
            and 8.3 <= (
        ...
        "open_water_evidence_scope_integrity": bool(
            ...
            == "broad_external_temperature_sanity_check_not_quantitative_validation"
            and ssp245["open_water_validation"]["used_for_tuning"] is False
            and ssp245["open_water_validation"]["release_gate_role"]
            == "broad_range_sanity_only"
    ...
    write_json("VALIDATION_SUMMARY_V2_29_6.json", summary)
    write_json("DEEP_VALIDATION_V2_29_6.json", deep)
    ...
    audit = {
        ...
        "source_files": {
            ...
            for name in (
                ...
                "V2_29_6_NATIVE_ARCTIC_INTEGRITY.md",
                "V2_29_6_ACCURACY_AND_VALIDATION.md",
                "V2_29_6_POST_FIX_REVIEW.md",
                "smoke_test.py", "structural_fixes_v2_17_0_test.py",
                "long_hold_salinity_exchange_test.py", "validate_v2296.py",
                ...
                "tools/package_v2296.py",
                "tools/run_v2296_validation_parallel.py",
            )
        },
        ...
        "known_scope_limits": [
            ...
            "The packaged OISST bounds are informational sanity metadata only: source hashes and processed output are absent, two JJA sector values exceed the broad envelopes, and no quantitative open-water validation claim is made.",
            ...
            "The 20 Sv positive hydraulic-target saturation is a reduced-order drag/source-water closure for extreme long-hold recovery experiments, not an observationally calibrated upper-bound forecast.",
        ],
        "configuration_snapshot": asdict(ModelConfig()),
    }
    write_json("IMPLEMENTATION_AUDIT_V2_29_6.json", audit)
    print(json.dumps({
    ...
    if not deep["all_release_checks_passed"]:
        ...
        raise SystemExit("v2.29.6 release validation failed: " + ", ".join(failed))
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v2296_") as directory:
        root = Path(directory)
