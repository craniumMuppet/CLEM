#!/usr/bin/env python3
"""Generate synchronized v2.29.1 Arctic phase-consistency validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    ...
    summary = {
        ...
        "supplementary_pathways_not_used_for_v2291_phase_fix_tuning": {
    ...
    release_checks = {
        ...
        "control_stability": bool(
            ...
            and abs(tasks["control"]["final_salt_conservation_error_ppm"]) <= 1.0e-3
        ),
    ...
    write_json("VALIDATION_SUMMARY_V2_29_1.json", summary)
    write_json("DEEP_VALIDATION_V2_29_1.json", deep)
    ...
    audit = {
        ...
        "implemented_structural_changes": {
            ...
            "exact_whole_domain_salt_projection": True,
            "public_interface_defaults_synchronized": True,
            "monte_carlo_arctic_hard_filters": True,
        },
        "known_scope_limits": [
            ...
            "The periodic shallow reference ocean uses calibrated heat-convergence restoring rather than explicit circulation.",
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_29_1.json", audit)
    print(json.dumps({
    ...
    if not deep["all_release_checks_passed"]:
        ...
        raise SystemExit("v2.29.1 release validation failed: " + ", ".join(failed))
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v2291_") as directory:
        root = Path(directory)
