#!/usr/bin/env python3
"""Generate synchronized v2.29.11 accuracy and evidence-integrity validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    """Assemble v2.29.11 records with evidence and release gates separated."""
    ...
    release_checks = {
        "v22911_version": MODEL_VERSION == "2.29.11",
    ...
    write_json("VALIDATION_SUMMARY_V2_29_11.json", summary)
    write_json("DEEP_VALIDATION_V2_29_11.json", deep)
    ...
    audit_source_names = (
        ...
        "V2_29_11_TARGET_BASELINE_SAFETY.md", "README.md", "CHANGELOG.md",
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_29_11.json", audit)
    ...
    if not summary["all_release_checks_passed"]:
        ...
        raise SystemExit("v2.29.11 release validation failed: " + ", ".join(failed))
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v22911_") as directory:
