#!/usr/bin/env python3
"""Streamlit dashboard for the emergent-sensitivity climate model v2.29.23."""
...
st.set_page_config(
    page_title="Emergent-Sensitivity Climate Model",
    page_icon="🌍",
    layout="wide",
)
...
st.title(f"Emergent-Sensitivity Global Climate Model v{MODEL_VERSION}")
st.caption(
