"""Regression checks for the v2.29.28 review cleanup."""
...
def test_version_and_emergency_guard_semantics():
 cfg=ModelConfig(); assert MODEL_VERSION=="2.29.28"; assert cfg.arctic_max_equivalent_thickness_m==20.0; assert cfg.arctic_max_local_ice_thickness_m==500.0
