...
def test_recalibrated_arctic_defaults_are_locked_and_inside_declared_priors() -> None:
    ...
    expected={
        ...
        "arctic_ice_nonsolar_heat_loss_wm2":47.8,
        ...
        "arctic_forced_ocean_heat_convergence_saturation_scale_c":0.32,
...
def test_packaged_recalibration_enforces_level_trend_and_physical_gates() -> None:
    ...
    assert osi["months"]["3"]["rmse_le_1p00_million_km2"] is True
    assert osi["months"]["9"]["rmse_le_1p00_million_km2"] is False
