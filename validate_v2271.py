#!/usr/bin/env python3
"""Generate synchronized v2.27.1 development and structural validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    ...
    write_json("VALIDATION_SUMMARY_V2_27_1.json", summary)
    ...
    write_json("DEEP_VALIDATION_V2_27_1.json", deep)
    ...
    audit = {
        ...
        "implemented_structural_changes": {
            ...
            "explicit_bulk_surface_temperature_product": True,
            "explicit_global_near_surface_air_temperature_product": True,
            "explicit_arctic_ocean_interface_temperature_product": True,
            "like_for_like_near_surface_air_arctic_amplification": True,
            "multi_resolution_reference_cycle_regressions": True,
            "isolated_test_runner": True,
            "isolated_validation_runner": True,
        },
        "known_scope_limits": [
            "Partially ice-covered cells still use the v2.27 equivalent-thickness thermodynamic closure; fractional ice/open-water flux splitting is reserved for v2.28.",
            "The full snow, pond, and conductive energy balance generates the reference cycle; transient anomaly physics remains the reduced v2.27 closure pending v2.28.",
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_27_1.json", audit)
    print(
        json.dumps(
            {
