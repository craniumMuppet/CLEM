#!/usr/bin/env python3
"""Run the canonical tree-bound v2.29.28 engineering regression suite."""
...
from tools.v22928_release_integrity import (
    ROOT,
    TEST_EVENTS,
    TEST_JSON,
    TEST_JUNIT,
...
DEFAULT_TEST_ARGS = [
    ...
    "tests/test_v22928_release_finalization.py",
    "tests/test_v22928_coupled_fail_closed.py",
...
def write_outputs(
    ...
    (output_dir / TEST_TXT).write_text(
        "\n".join(
            [
                "EGCM v2.29.28 unchanged-tree machine-verifiable test evidence",
