...
PARAMETER_ALIASES: dict[str, str] = {
    ...
    "amoc_interhemispheric_temperature_coupling": "amoc_interhemispheric_temperature_coupling",
    ...
    "amoc_pycnocline_relaxation_years": "amoc_pycnocline_relaxation_years",
    "amoc_convection_critical_density_ratio": "amoc_convection_critical_density_ratio",
    "amoc_convection_transition_width": "amoc_convection_transition_width",
    ...
    "amoc_convection_transport_exponent": "amoc_convection_transport_exponent",
...
PHYSICAL_AMOC_PRIORS: dict[str, PriorSpec] = {
    ...
    "amoc_interhemispheric_temperature_coupling": PriorSpec(0.0, 0.20, "uniform", None, "interhemispheric density contrast", "Weakly informative bounded coupling."),
    ...
    "amoc_pycnocline_relaxation_years": PriorSpec(40.0, 500.0, "lognormal", 150.0, source="thermocline adjustment", rationale="Positive response timescale."),
    "amoc_convection_critical_density_ratio": PriorSpec(0.84, 0.97, "beta", 0.91, 8.0, "deep-convection response centre", "Places the smooth convection response near the forced operating range while retaining continuous dynamics."),
    "amoc_convection_transition_width": PriorSpec(0.015, 0.12, "lognormal", 0.035, source="heterogeneous convection response", rationale="Positive transition width for the continuous response."),
    ...
    "amoc_convection_transport_exponent": PriorSpec(0.5, 1.5, "uniform", None, source="convection-overturning scaling", rationale="Unity gives direct proportional coupling; the prior permits sublinear or superlinear sensitivity."),
