...
setlocal
cd /d "%~dp0"
echo Coupled Low-complexity Earth Model v2.29.28 out-of-sample validation
echo Repair-workflow R12 validation design; current R13 package preserves the validated dynamics.
