#!/usr/bin/env python3
"""Run and combine current-source v2.29.29 validation at 5 and 10 degrees.
...
VALIDATOR = ROOT / "validate_v22929.py"
COMBINER = ROOT / "combine_v22929_validation.py"
ARTIFACT_NAMES = tuple(
    [f"SEA_ICE_VALIDATION_V2_29_29_{resolution}DEG.json" for resolution in (5, 10)]
    + [
...
SUMMARY_NAME = "VALIDATION_SUMMARY_V2_29_29.json"
...
def main() -> None:
    ...
    staging = Path(tempfile.mkdtemp(prefix="v22929-coupled-", dir=output_dir))
    try:
        _run_resolutions(
            [
                [
