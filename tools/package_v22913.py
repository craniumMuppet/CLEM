#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.13 scientific-review-fix archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_13_integrity_amoc_baseline"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
REQUIRED = (
    ...
    "run_state.py",
    "co2_target_sweep.py",
    "V2_29_13_INTEGRITY_AND_AMOC_BASELINE.md",
    "VALIDATION_SUMMARY_V2_29_13.json",
    "DEEP_VALIDATION_V2_29_13.json",
    "IMPLEMENTATION_AUDIT_V2_29_13.json",
    "PACKAGE_FILE_MANIFEST_V2_29_13.json",
    "TEST_RESULTS_V2_29_13.txt",
    ...
    "tools/package_v22913.py",
    "tools/run_v22913_validation_parallel.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_13.json"
    entries = []
