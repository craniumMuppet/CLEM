#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.16 winter sea-ice integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_16_release_integrity_outputs"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_16.json"
    entries = []
