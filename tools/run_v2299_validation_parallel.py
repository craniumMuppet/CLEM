#!/usr/bin/env python3
"""Run all v2.29.9 validation tasks in isolated parallel subprocesses.
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "validation_v2299_tasks_final",
    )
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    from validate_v2299 import _assemble_records
