#!/usr/bin/env python3
"""Fail closed if the EGCM v2.29.28 tested tree differs from its fingerprint."""
from __future__ import annotations

from v22928_release_integrity import FINGERPRINT_JSON, ROOT, load_json, verify_fingerprint_payload
