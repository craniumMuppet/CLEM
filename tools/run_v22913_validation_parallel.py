#!/usr/bin/env python3
"""Run all v2.29.13 validation tasks in isolated parallel subprocesses.
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "validation_v22913_tasks_final",
    )
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    from validate_v22913 import _assemble_records
