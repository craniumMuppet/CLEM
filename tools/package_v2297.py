#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.7 accuracy and evidence-integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_7_arctic_temporal_skill"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
REQUIRED = (
    ...
    "PACKAGE_FILE_MANIFEST_V2_29_7.json",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_7.json"
    entries = []
