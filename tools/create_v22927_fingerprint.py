#!/usr/bin/env python3
"""Create the tested-code-and-scientific-input fingerprint for EGCM v2.29.27."""
from __future__ import annotations

import json

from v22927_release_integrity import FINGERPRINT_JSON, ROOT, create_fingerprint_payload
