#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.11 scientific-review-fix archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_11_target_baseline_safety"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v22911_tasks/",
    "validation_v22911_tasks_final/",
)
...
REQUIRED = (
    ...
    "run_state.py",
    "co2_target_sweep.py",
    "V2_29_11_TARGET_BASELINE_SAFETY.md",
    "VALIDATION_SUMMARY_V2_29_11.json",
    "DEEP_VALIDATION_V2_29_11.json",
    "IMPLEMENTATION_AUDIT_V2_29_11.json",
    "PACKAGE_FILE_MANIFEST_V2_29_11.json",
    "TEST_RESULTS_V2_29_11.txt",
    ...
    "tools/package_v22911.py",
    "tools/run_v22911_validation_parallel.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_11.json"
    entries = []
