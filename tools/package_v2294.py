#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.4 accuracy and evidence-integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_4_accuracy_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_PREFIXES = (
    ...
    "validation_v2294_tasks/",
    "validation_v2294_tasks_final/",
)
EXCLUDED_SUFFIXES = (".pyc", ".pyo", ".tmp", ".bak", ".tolbak", ".stage0")
EXCLUDED_FILE_NAMES = set()
EXCLUDED_FILE_PREFIXES = (
    "validation_v2294_test_nodes",
    "validation_v2294_test_results",
    "validation_v2294_isolated_runner",
    "validation_v2294_parallel_runner",
    "validation_v2294_suite_",
)
REQUIRED = (
    "climate_model.py",
    "monte_carlo.py",
    ...
    "VALIDATION_SUMMARY_V2_29_4.json",
    "DEEP_VALIDATION_V2_29_4.json",
    "IMPLEMENTATION_AUDIT_V2_29_4.json",
    "TEST_RESULTS_V2_29_4.txt",
    "validate_v2294.py",
    "run_tests.py",
...
def release_files() -> list[Path]:
    ...
    for path in ROOT.rglob("*"):
        ...
        if relative.name.startswith(EXCLUDED_FILE_PREFIXES):
            continue
        if relative_text.startswith("validation_v2294_test_logs"):
            continue
        files.append(path)
