#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.27.0 source release archive."""
...
PREFIX = "emergent_global_climate_model_v2_27_0"
EXCLUDED_PREFIXES = (
...
REQUIRED = (
    "climate_model.py",
    "README.md",
    "V2_27_0_ARCTIC_GREENLAND_REBUILD.md",
    "V2_23_COMPATIBILITY_V2_27_0.md",
    "VALIDATION_SUMMARY_V2_27_0.json",
    "DEEP_VALIDATION_V2_27_0.json",
    "IMPLEMENTATION_AUDIT_V2_27_0.json",
    "TEST_RESULTS_V2_27_0.txt",
    "run_tests.py",
...
def build(output_dir: Path) -> tuple[Path, Path]:
    ...
    missing = [name for name in REQUIRED if name not in tracked_relative]
    if missing:
