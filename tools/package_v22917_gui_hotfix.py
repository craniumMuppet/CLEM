#!/usr/bin/env python3
"""Build the EGCM v2.29.17 desktop-GUI startup hotfix archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_17_gui_startup_hotfix"
MANIFEST_NAME = "PACKAGE_FILE_MANIFEST_V2_29_17_GUI_HOTFIX.json"
...
REQUIRED = {
    ...
    "run_gui_debug.bat",
    "setting_metadata.py",
    "GUI_STARTUP_HOTFIX_V2_29_17.md",
    "TEST_RESULTS_V2_29_17_GUI_HOTFIX.txt",
    "gui_startup_smoke_test.py",
    "tests/test_v22917_gui_startup.py",
...
def write_manifest() -> Path:
    ...
    manifest = {
        ...
        "package_variant": "desktop_gui_startup_hotfix",
...
def main() -> None:
    ...
    if missing:
        raise SystemExit(f"Missing required hotfix files: {missing}")
    ...
    with zipfile.ZipFile(archive, "w", zipfile.ZIP_DEFLATED, compresslevel=9) as target:
        for source in files:
            ...
            info.date_time = (2026, 8, 3, 3, 45, 0)
