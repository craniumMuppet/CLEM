#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.0 coupled-Arctic-ocean archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_0_coupled_arctic_ocean"
EXCLUDED_PREFIXES = (
...
REQUIRED = (
    ...
    "README.md",
    "CHANGELOG.md",
    "V2_29_0_COUPLED_ARCTIC_OCEAN.md",
    "VALIDATION_SUMMARY_V2_29_0.json",
    "DEEP_VALIDATION_V2_29_0.json",
    "IMPLEMENTATION_AUDIT_V2_29_0.json",
    "TEST_RESULTS_V2_29_0.txt",
    "validate_v229.py",
    "run_tests.py",
    "isolated_pytest_exit.py",
    "tests/test_v229_coupled_arctic_ocean.py",
)
