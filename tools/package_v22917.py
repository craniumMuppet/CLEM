#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.17 Arctic and CO2-sweep integrity archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_17_arctic_sweep_integrity"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
EXCLUDED_FILE_NAMES = {
    "validation_v22913_runner.pid",
    "validation_v22913_runner.log",
    "validation_v22914_runner.pid",
    "validation_v22914_runner.log",
    "validation_v22916_runner.pid",
    "validation_v22916_runner.log",
    ...
    "v22916_review_reproduction.log",
    "v22916_review_reproduction.pid",
    "v22916_review_reproduction.exit",
    "v22916_legacy_tests.log",
    "v22916_legacy_tests.pid",
    "v22916_legacy_tests.exit",
...
REQUIRED = (
    "V2_29_17_ARCTIC_SWEEP_INTEGRITY.md",
    "TEST_RESULTS_V2_29_17.txt",
    "tests/test_v22917_arctic_sweep_integrity.py",
    "trusted_validation_pickle.py",
    "rerun_co2_target_sweep_v22917.ps1",
    "tools/package_v22917.py",
    "climate_model.py",
    "monte_carlo.py",
    "app.py",
    ...
    "V2_29_16_REVIEW_REPRODUCTION.json",
    "V2_29_15_WINTER_SEA_ICE_INTEGRITY.md",
    "V2_29_15_REVIEW_REPRODUCTION.json",
    "V2_29_14_RECOVERY_AND_WINTER_SEA_ICE.md",
    "VALIDATION_SUMMARY_V2_29_16.json",
    "DEEP_VALIDATION_V2_29_16.json",
    "IMPLEMENTATION_AUDIT_V2_29_16.json",
    "PACKAGE_FILE_MANIFEST_V2_29_16.json",
    "TEST_RESULTS_V2_29_16.txt",
    "tests/test_v2298_resumable_sweeps.py",
    "tests/test_v22910_integrity_recovery.py",
    "tests/test_v22911_target_baseline_safety.py",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_17.json"
    entries = []
...
def build(output_dir: Path) -> tuple[Path, Path]:
    ...
    with zipfile.ZipFile(archive) as source:
        ...
        if any(
            ...
            or Path(name).name in EXCLUDED_FILE_NAMES
            for name in names
        ):
