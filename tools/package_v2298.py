#!/usr/bin/env python3
"""Build and verify the clean EGCM v2.29.8 resumable long-run archive."""
...
PREFIX = "emergent_global_climate_model_v2_29_8_resumable_long_runs"
EXCLUDED_DIR_NAMES = {
    ".git",
    ".pytest_cache",
    "__pycache__",
...
REQUIRED = (
    ...
    "run_state.py",
    "co2_target_sweep.py",
    "V2_29_8_RESUMABLE_LONG_RUNS.md",
    "VALIDATION_SUMMARY_V2_29_8.json",
    "DEEP_VALIDATION_V2_29_8.json",
    "IMPLEMENTATION_AUDIT_V2_29_8.json",
    "PACKAGE_FILE_MANIFEST_V2_29_8.json",
    "TEST_RESULTS_V2_29_8.txt",
...
def write_full_file_manifest() -> Path:
    ...
    """
    manifest_path = ROOT / "PACKAGE_FILE_MANIFEST_V2_29_8.json"
    entries = []
