#!/usr/bin/env python3
"""Generate synchronized v2.29.12 accuracy and evidence-integrity validation records."""
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    """Assemble v2.29.12 records with evidence and release gates separated."""
    ...
    release_checks = {
        "v22912_version": MODEL_VERSION == "2.29.12",
    ...
    write_json("VALIDATION_SUMMARY_V2_29_12.json", summary)
    write_json("DEEP_VALIDATION_V2_29_12.json", deep)
    ...
    audit_source_names = (
        ...
        "V2_29_12_MONTE_CARLO_INTEGRITY.md", "README.md", "CHANGELOG.md",
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_29_12.json", audit)
    ...
    if not summary["all_release_checks_passed"]:
        ...
        raise SystemExit("v2.29.12 release validation failed: " + ", ".join(failed))
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v22912_") as directory:
