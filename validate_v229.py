#!/usr/bin/env python3
"""Generate synchronized v2.29 coupled-Arctic validation records."""
...
def _pathway_summary_task(scenario: str) -> dict[str, float]:
    _, raw = scenario_run(scenario, dt=0.05, record_every=0.1)
...
def _assemble_records(tasks: dict[str, Any]) -> None:
    ...
    summary = {
        ...
        "supplementary_pathways_not_used_for_v229_coupling_tuning": {
    ...
    write_json("VALIDATION_SUMMARY_V2_29_0.json", summary)
    ...
    for prefix in ("atlantic", "non_atlantic"):
        ...
        arctic_resolution_spreads[prefix] = {
            "minimum_area_mean_ice_fraction_spread": max(values) - min(values),
    ...
    write_json("DEEP_VALIDATION_V2_29_0.json", deep)
    ...
    audit = {
        ...
        "implemented_structural_changes": {
            ...
            "maximum_ice_thickness_overflow_conserved_to_bulk_ocean": True,
            "two_way_arctic_ocean_surface_exchange": True,
            "ocean_temperature_dependent_basal_ice_heat_flux": True,
            "equal_and_opposite_arctic_ocean_surface_energy_transfer": True,
            "periodic_sector_shallow_reference_ocean": True,
            "open_water_temperature_ceiling_removed": True,
            ...
            "arctic_specific_resolution_convergence_metrics": True,
            "supplementary_ssp126_and_ssp460_pathways": True,
        ...
        "known_scope_limits": [
            ...
            "The periodic shallow reference ocean is restored by a calibrated heat-convergence closure rather than explicit ocean circulation.",
    ...
    write_json("IMPLEMENTATION_AUDIT_V2_29_0.json", audit)
    print(
        json.dumps(
            {
                ...
                "supplementary_pathways": summary["supplementary_pathways_not_used_for_v229_coupling_tuning"],
                "energy_audit": summary["energy_audit"],
                "arctic_resolution_spreads": deep["arctic_resolution_spreads"],
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="validation_v229_") as directory:
        root = Path(directory)
